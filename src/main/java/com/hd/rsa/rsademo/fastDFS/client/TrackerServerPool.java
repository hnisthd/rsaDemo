package com.hd.rsa.rsademo.fastDFS.client;
...
public class TrackerServerPool {
     ...
     */
    private static final String FASTDFS_CONFIG_PATH = "fastFDSConfig.properties";
    ...
    public static TrackerServer borrowObject() throws FastDFSException {
        ...
        try {
            GenericObjectPool<TrackerServer> genericObjectPool = getObjectPool();
            trackerServer = genericObjectPool.borrowObject();
        } catch (Exception e) {
            e.printStackTrace();
