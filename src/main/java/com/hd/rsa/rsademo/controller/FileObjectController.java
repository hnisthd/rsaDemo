...
import com.hd.rsa.rsademo.fastDFS.client.*;
...
public class FileObjectController {
     ...
     * 文件服务器地址
     */
    private String fileServerAddr = "192.168.238.136:8080";

    /**
     * FastDFS秘钥
     */
    private String fastDFSHttpSecretKey = "FASTDFS20181204";
    ...
    public FileResponseData uploadFileSample(MultipartFile file, HttpServletRequest request){
        FileItem fileItem = createFileItem("C:\\Users\\Administrator\\Desktop\\11.png");
        MultipartFile mfile = new CommonsMultipartFile(fileItem);
        FileResponseData fileResponseData = uploadSample(mfile, request);
